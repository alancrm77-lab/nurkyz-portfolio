...
const D = {
  en: {
    ...
    heroPhotoAlt: 'Nurkyz seated in a black blazer and white dress',
    ...
    podcastDesc: 'Candid conversations on life, relationships and the things nobody says out loud. New episodes land on YouTube — subscribe so you catch the next one.',
  ...
  ru: {
    ...
    heroPhotoAlt: 'Нуркыз в чёрном пиджаке и белом платье',
    ...
    podcastDesc: 'Откровенные разговоры о жизни, отношениях и о том, о чём обычно молчат. Новые выпуски выходят на YouTube — подпишитесь, чтобы не пропустить.',
